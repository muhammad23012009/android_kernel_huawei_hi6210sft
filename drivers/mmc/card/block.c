...
#include "hisi_partition.h"    /*DTS2014080605270 add 20140807*/
...
/* BEGIN PN:DTS2016042003896 , Modified by d00168349, 2016/04/20 */
...
#endif
/* END PN:DTS2016042003896 , Modified by d00168349, 2016/04/20 */
...
>>>>>>> cb99ff2b40d4357e990bd96b2c791860c4b0a414
			 ...
			 */
<<<<<<< HEAD
			pr_err("%s: status==MMC_BLK_ECC_ERR\n", __func__);
=======
>>>>>>> cb99ff2b40d4357e990bd96b2c791860c4b0a414
...
/* BEGIN PN: DTS2016041105021, Deleted by cwx212840, 2016/04/11*/
#if 0
...
#endif
/* END PN: DTS2016041105021, Deleted by cwx212840, 2016/04/11*/
...
<<<<<<< HEAD
    ...
    if(MMC_TYPE_MMC == card->type)
	{
	  ...
	  /*NV1*/
	  /*mmcblk0p11 -> mmcblk0p10 ,0xB30B -> 0xB30A DTS2014072800639 2014/7/29 14:12*/
	  /*"/dev/block/mmcblk0p10" -> BLK_MODEMNVM1 DTS2014080605270 20140805*/
...
#endif
	/*modemnvbkup*/
	/*mmcblk0p7 -> mmcblk0p6 ,0xB307 -> 0xB306 DTS2014072800639  2014/7/29 14:10*/
	/*"/dev/block/mmcblk0p6" -> BLK_MODEMNVBKUP DTS2014080605270 20140805*/
      err = sys_mknod(BLK_MODEMNVBKUP, S_IFBLK|S_IRWXU|S_IRWXG|S_IRWXO, 0xB306);
	if (err < 0) {
		printk("module_init mknod BLK_MODEMNVBKUP fail\n");
		}
	/*modemimage*/
	/*mmcblk0p14 -> mmcblk0p29,DTS2014072800639  2014/7/29 14:10*/
	/*"/dev/block/mmcblk0p29" -> BLK_MODEMIMAGE DTS2014080605270 20140805*/
	...
	/* for ccore reset*/
	/*modemnvm3*/
	/*mmcblk0p13 -> mmcblk0p12, 0xB30D -> 0xB30C  DTS2014072800639 2014/7/29 14:08*/
	/*"/dev/block/mmcblk0p12" -> BLK_MODEMNVM3 DTS2014080605270 20140805*/
      err = sys_mknod(BLK_MODEMNVM3, S_IFBLK|S_IRWXU|S_IRWXG|S_IRWXO, 0xB30C);
      if (err < 0) {
		printk("module_init mknod BLK_MODEMNVM3 fail\n");
		}
	/*dsp*/
	/*mmcblk0p15 -> mmcblk0p30, 0xB30F -> 0xB31E  DTS2014072800639 2014/7/29 14:07*/
	/*"/dev/block/mmcblk0p30" -> BLK_DSP DTS2014080605270 20140805*/
...
static int mmc_blk_suspend(struct mmc_card *card)
{
	...
	printk("%s:%d ++\n", __func__, __LINE__);
	ret = _mmc_blk_suspend(&card->dev, 0);
	printk("%s:%d --\n", __func__, __LINE__);
	return ret;
}
