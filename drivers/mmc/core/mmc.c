...
<<<<<<< HEAD
		...
		if (card->ext_csd.part_time &&
			...
			card->ext_csd.part_time = MMC_MIN_PART_SWITCH_TIME;
                ...
                /*The value of Sandisc emmc from ext_csd[EXT_CSD_PART_SWITCH_TIME] is not accurate*/
                if (CID_MANFID_SANDISK2 == card->cid.manfid) {
                        card->ext_csd.part_time = SANDISK_PART_TIME;
                        pr_info("sandisc [Sandisc emmc]: part_time need to change as %d ms.\n", card->ext_csd.part_time);
                }
=======
		card->ext_csd.part_time = 10 * ext_csd[EXT_CSD_PART_SWITCH_TIME];
>>>>>>> cb99ff2b40d4357e990bd96b2c791860c4b0a414
