...
#elif defined(CONFIG_CPU_FREQ_DEFAULT_GOV_OPTDEMAND)
extern struct cpufreq_governor cpufreq_gov_optdemand;
#define CPUFREQ_DEFAULT_GOVERNOR	(&cpufreq_gov_optdemand)
#endif
