...
/*< DTS2015021204710 c00106552 20150212 add begin */
#ifdef CONFIG_HW_WIFIPRO
		if((is_wifipro_on || wifi_is_on()  ) && tp->srtt != 0 && !(flag & FLAG_RETRANS_DATA_ACKED)){
...
<<<<<<< HEAD
		...
		/*DTS2014120900614 l00284158 20141209 begin*/
		if(icsk->icsk_retransmits > 2)/*DTS2014102705296 l00284158 20141027*/
		{
			...
			/*DTS2014112901223 l00284158 20141129  begin*/
			notify_chr_thread_to_send_msg(inet->inet_daddr,inet->inet_saddr);
			/*DTS2014112901223 l00284158 20141129  end*/
#endif 
		}
		else
		{
